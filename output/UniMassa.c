...

{
  ...
  switch( operacao ) {
	...
	case '2': printf("%.2f * 1000000 = %.4f gramas", numero, numero * 1000000); break;
    ...
    case '4': printf("%.2f * 1000 = %.2f gramas", numero, numero * 1000); break;
  	...
  	case '6': printf("%.2f / 1000000 = %.4f toneladas", numero, numero / 1000000); break;
